    ...
    if($farmerAvailable && $farmerAvailable['full_name']!=NULL && $farmerAvailable['id_number']!=NULL){
							...
							if($notificationAvailable && $notificationAvailable['sent_message']!=NULL && $notificationAvailable['farmer_id']!=NULL){
								...
								foreach($ussd_notifications as $index=>$ussd_notifications){
									if($ussd_notifications['status']=='1'){
									   ...
									   $sql6 = "UPDATE ussd_notifications SET `status`='0' WHERE `farmer_id` IN ( SELECT `id` FROM 
									   `farmers` WHERE phoneNumber LIKE '%".$phoneNumber."%')";
									   $db->query($sql6);
		...
		if($userResponse==""){
			...
			switch ($level) {
				...
				case 4:
			    	//10e. Request again for district - level has not changed...
        			$response = "CON District Not supposed To Be Empty.\nPlease select Your District \n";
			  		// Print the response onto the page so that our gateway can read it
			  		header('Content-type: text/plain');
 			  		echo $response;	
				break;
			...
			switch ($level) {
				...
				case 3:   			
					...
					if($userResponse=="1"){		
						...
						//query this on district level
						$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '29'";	
						
						//for district level assignment
						$farmers=$db->query($sql6);
						$farmerAvailable=$farmers->fetch_assoc();
					
						$response = "CON Likoma EPAs Are\n";
						foreach($farmers as $index=>$farmers){
							$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
						...
						//query this on district level
						$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '4'";	
				...
				case "4":			  
					...
					if($userResponse=="1"){
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Kameme', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Mwankhumba', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Masuku', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Lufita', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Chisanga', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Kavukuku', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
						...
						//11b. Update Name, and Request for District Name
						$sqlb = "UPDATE farmers SET `farmer_epa`='Nyika National Park', `farmer_district`='1' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
						$db->query($sqlb);
				...
				case 6:   // CENTRAL REGION			
					...
					if($userResponse=="1"){		
						...
						//query this on district level
						$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '3'";	
						...
						//query this on district level
						$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '28'";	
						
						//for district level assignment
						$farmers=$db->query($sql6);
						$farmerAvailable=$farmers->fetch_assoc();
					
						$response = "CON Ntcheu EPAs Are\n";
						foreach($farmers as $index=>$farmers){
							$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
				...
				elseif($userResponse=="3"){
					...
					//query this on district level
					$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '27'";	

					//for district level assignment
					$farmers=$db->query($sql6);
					$farmerAvailable=$farmers->fetch_assoc();
				
					$response = "CON Thyolo EPAs Are\n";
					foreach($farmers as $index=>$farmers){
						$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
					}
				}elseif($userResponse=="5"){
				...
				echo $response;	
				break;
				case 9:   // SOUTHERN REGION CONTINUATION		
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`=4 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				if($userResponse=="1"){		
					...
					//query this on district level
					$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '25'";	

					//for district level assignment
					$farmers=$db->query($sql6);
					$farmerAvailable=$farmers->fetch_assoc();
				
					$response = "CON Salima EPAs Are\n";
					foreach($farmers as $index=>$farmers){
						$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
					}
				} 
