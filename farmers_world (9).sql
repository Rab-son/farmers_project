...
(34, 'rabsonsayendajnrkk@gmail.com', 'd41d8cd98f00b204e9800998ecf8427e', 'Sub Admin', 1, 1, 1, 1, 1, 1, '2020-10-02 16:11:28', '2020-11-14 23:18:06');
...
CREATE TABLE `epas` (
  ...
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `epaname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(139, '19', 'Mzenga', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
CREATE TABLE `farmers` (
  ...
  `location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Assigned',
  `farmer_epa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Assigned',
  `farmer_district` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `farmers` (`id`, `parent_id`, `full_name`, `id_number`, `birthday_date`, `location`, `farmer_epa`, `farmer_district`, `sex`, `phonenumber`, `next_of_kin`, `farm_activity`, `produce`, `remember_token`, `created_at`, `updated_at`) VALUES
(216, 0, 'Rabson Sayenda', 'uuutu', '1917-08-01', 'Not Assigned', 'Lilangwe', '2', '1', '0886473454345', 'Esther Phiri', 'Crop Production', 'Not Available', NULL, '2020-11-15 22:46:58', '2020-11-15 22:46:58'),
(217, 0, 'RRRRR SSSS', '', '0000-00-00', '1', 'Not Assigned', '', NULL, '08864734543451', 'Not Assigned', 'Not Assigned', 'Not Available', NULL, '2020-11-15 19:10:22', '2020-11-15 19:10:22');
...
(34, '39', 'Not Assigned', 'Lilangwe', '2', '39', 'Chimanga', 10.00, '10', 'llllll', '100', 1, '2020-11-16 02:47:52', '2020-11-16 02:47:52'),
(35, '39', 'Not Assigned', 'Lilangwe', '2', '39', 'Chimanga', 10.00, '10', 'llllll', '100', 1, '2020-11-16 02:47:53', '2020-11-16 02:47:53'),
(37, '39 Agora', 'Not Assigned', 'Chingale', '1', '39 Agora', 'Chimanga', 101.00, '101', 'kkkk', '10', 1, '2020-11-16 03:00:51', '2020-11-16 03:00:51'),
...
(61, 'Bika Agro-dealer', 0, 'Not Assigned', 'Kunthembwe', '2', '0996788210', '9AM-5PM', 'Monday-Sunday', '2020-11-15 23:44:14', '2020-11-15 23:44:14');
...
(69, 216, 'George Kondoni', 'fdasaflkdafld', NULL, '0', NULL, '2020-11-16 02:24:19', '2020-11-16 02:24:19'),
...
--
ALTER TABLE `districts`
  MODIFY `epa_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `markets`
  MODIFY `mark_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
