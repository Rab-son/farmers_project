    ...
    if($farmerAvailable && $farmerAvailable['full_name']!=NULL && $farmerAvailable['id_number']!=NULL){
				...
				switch($userResponse){
					case "1":
						...
						// Display this if they are no services at both district and epa level
							...
							$response .= "Enterprises are not selling anything at the moment,\nPlease Check Later\n\n"; 
						}
					...
					case "2":
						...
						// Display this if they are no services at both district and epa level
							...
							$response .= "Agro-Dealers are not selling anything at the moment,\nPlease Check Later\n\n";
						}
					...
					case "3":
						...
						// Display this if they are no services at both district and epa level
							...
							$response .= "Investments are not selling anything at the moment,\nPlease Check Later\n\n"; 
						}
				...
				switch($userResponse){
					case "1":
						...
						elseif ($marketDistrictAvailable2 && $marketDistrictAvailable2['farmer_district']!==NULL && $marketDistrictAvailable['buying_price']!=NULL){
							...
							$response .= "Admarc Are not Selling Anything At The Moment,\nPlease Check Later\n\n"; 
						}
					...
					case "2":
						...
						elseif ($marketDistrictAvailable2 && $marketDistrictAvailable2['farmer_district']!==NULL && $marketDistrictAvailable['buying_price']!=NULL){
							...
							$response .= "Agora Are not Selling Anything At The Moment,\nPlease Check Later\n\n"; 
						}
		...
		//Menu 4*2. Farm Management of Maize 
			...
			if(!$userResponse==""){
				...
				$response .="For $userResponse Maize Bag(s) of 70Kgs,\nYou will need:\n\n>. $maizeYieldOf70kgs hectares of land\n>. $npkBags NPK Fertilizer Bag(s)\n>. $ureaBags Urea Fertilizer Bag(s)\n>. Moderate rainfall.\n\n";
		...
		//Changing Account Name and Location
			...
			if(!$userResponse==""){
				switch($userResponse){
					...
					break;
					case "2":  //START WITH REGIONS AS IN REGISTRATION AND PROCEED TO EPAS
						if($level==18){
		...
		//Changing Location
			...
			if($userResponse=="1"){		
				//query this on district level
				// Graduate user to level 2          //START HERE AND GO TO LEVEL 68
				$sqltt = "UPDATE `session` SET `level`=68 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				...
				$sqltt = "UPDATE `session` SET `level`=69 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				...
				$response = "CON You have successfully Changed You District\n";
				$response .= "Your New EPA From Selected District Is:\n\n"; 
				
				$response .= "District: Likoma\n\n";
				$response .= "No EPAs For Likoma\n\n";
				...
				$sqltt = "UPDATE `session` SET `level`= 70 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 72 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 73  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				...
				switch ($userResponse){ 	// from this point we are using user input as a case variable
					case "1":   			// if the choice is 1 the user go to nglish version
						if($level==23){
							...
							$response = "CON farmers World\n";
							$response .= "My Account Option\n\n";
					...
					case "3": // user will be here if he chooses option 3 in Chichewa menu
						if($level==24){
							...
							elseif ($advisorDistrictAvailable2 && $advisorDistrictAvailable2['farmer_district']!==NULL && $advisorDistrictAvailable['advisor_distric']!=NULL){
								...
								$response .= "Mulibe Alangizi Mu Dela Lanu\n\n"; 
							}				
		...
		//Menu 4*2. FarmMAnagement of Cotton
			...
			if(!$userResponse==""){
				...
				$response .="For $userResponse Cotton Bag(s) of 50Kgs,\nYou will need:\n\n>. $CottonYieldOf50kgs hectares of land\n>. $npkBags NPK Fertilizer Bag(s)\n>. $ureaBags Urea Fertilizer Bag(s)\n>. Moderate rainfall.\n\n";
			...
			if(!$userResponse==""){
				...
				$response .="For $userResponse Cotton Bag(s) of 70Kgs,\nYou will need:\n\n>. $CottonYieldOf70kgs hectares of land\n>. $npkBags NPK Fertilizer Bag(s)\n>. $ureaBags Urea Fertilizer Bag(s)\n>. Moderate rainfall.\n\n";
		...
		//Menu 4*3. FarmMAnagement of Tobacco
			...
			if(!$userResponse==""){
				...
				$response .="For $userResponse Tobbaco Bag(s) of 70Kgs,\nYou will need:\n\n>. $TobbacoYieldOf70kgs hectares of land\n>. $npkBales NPK Fertilizer Bag(s)\n>. $ureaBales Urea Fertilizer Bag(s)\n>. Moderate rainfall.\n\n";
			...
			if(!$userResponse==""){
				switch($userResponse){
					case "1":
						...
						$response = "CON Mwasankha Enterprise a Mu Dela lanu\n";
						...
						// Display this if they are no services at both district and epa level
							...
							$response .= "Enterprises sakugulisa kalikonse pakadali pano,\nChonde zaoneninso nthawi yina\n\n"; 
						}
					...
					case "3":
						...
						// Display this if they are no services at both district and epa level
							...
							$response .= "Investments sakugulisa kalikonse pakadali pano,\nChonde zaoneninso nthwayi ina\n\n"; 
						}
				...
				switch($userResponse){
					case "1":
						...
						elseif ($marketDistrictAvailable2 && $marketDistrictAvailable2['farmer_district']!==NULL && $marketDistrictAvailable['buying_price']!=NULL){
							...
							$response .= "Admarc Sakugula Kalikonse Pano,\nChonde Zaoneninso nthawi ina\n\n"; 
						}						
					...
					case "2":
						...
						elseif ($marketDistrictAvailable2 && $marketDistrictAvailable2['farmer_district']!==NULL && $marketDistrictAvailable['buying_price']!=NULL){
							...
							$response .= "Agora Sakugulitsa kalikonse pakadali pano,\nChonde zaoneninso nthawi ina.\n\n"; 
						}						
					...
					case "3":
						...
						elseif ($marketDistrictAvailable2 && $marketDistrictAvailable2['farmer_district']!==NULL && $marketDistrictAvailable['buying_price']!=NULL){
							...
							$response .= "Agro-Dealers sakugulisa kalikonse pakadali pano,\nChonde zaoneninso nthawi yina\n\n"; 
						}
			...
			if(!$userResponse==""){
				switch($userResponse){
					...
					case "3":
						...
						$response = "CON  Kusamalira Zakumunda\n";
						$response .= "Fodya\n";
                        $response .= "Sankhani Kuchuluka Kwa Belo\n\n";
				...
				switch($userResponse){
					case "1":
						if($level==54){
                            ...
                            $response = "CON Kusamala Za Kumunda\n";
                            $response .= "Fodya\n\n";
							$response .= "Lowesani Mulingo Wa Belo la 50Kg\n\n";				
					...
					case "2":
						if($level==54){
                            ...
                            $response = "CON Kusamala Za Kumunda\n";
                            $response .= "Fodya\n\n";
                            $response .= "Lowesani Mulingo Wa Belo la 70Kg\n\n";
					...
					default:
						if($level==54){
                            ...
                            $response .= "Kusamala Za Ku Munda\n";
                            $response .= "Fodya\n";                        
                            $response .= "Sankhani Kuchuluka Belo\n\n";
								...
								foreach($ussd_notifications as $index=>$ussd_notifications){
									if($ussd_notifications['status']=='1'){
									   ...
									   $sql6 = "UPDATE ussd_notifications SET `status`='0' 
										...
										$response .= "Mulibe Mauthenga Osawelengwa\n\n";
			...
			if(!$userResponse==""){
				switch($userResponse){
					case "1":
						...
						$response .= "1. Sinthani Dzina lanu\n";
						$response .= "2. Sinthani Dela lanu\n";
						$response .= "3. Kubwerera pambuyo";
				...
				switch($userResponse){
					...
					case "2":
						if($level==62){
							...
							$response = "CON Kosintha Za Account\n";
							$response .= "Sankhani Chigawo Cha Malawi,\nKomwe Mukuchokera\n\n";

							$response .= "1. Chigawo Cha Kumpoto\n";
							$response .= "2. Chigawo Cha Pakati\n";
							$response .= "3. Chigawo Cha Kumwera\n";
		...
		//Changing Location, Chichewa
			...
			if($userResponse==1){
				...
				$response = "CON Sankhani Boma Lomwe Mukukhala\n";
				$response .= "Chigawo Cha Kumpoto\n\n";
				$response .= "1. Chitipa\n";
				$response .= "2. Karonga\n";
				$response .= "3. Likoma\n";
				$response .= "4. Mzimba\n";
		...
		//Northern Region EPAs, Chichewa Version
		else if($level==66){

			if($userResponse=="1"){		
				//query this on district level
				// Graduate user to level 2          //START HERE AND GO TO LEVEL 68
				$sqltt = "UPDATE `session` SET `level`=99 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				...
				$response = "CON Ma EPA a Ku Chitipa\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
														
				}	
			}elseif($userResponse=="2"){
				$sqltt = "UPDATE `session` SET `level`=100 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '11'";	
				...
				$response = "CON Ma EPA a Ku Karonga\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
				...
				//query this on district level
				$sqltt = "UPDATE `session` SET `level`= 61 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				//11f. Serve the menu request for name
				$response = "CON Mwakwanisa Kusintha Dela Lanu\n";
				$response .= "EPA Ya Dela Lomwe Mwasankha Ndi:  \n\n"; 
				

				$response .= "Likoma ilibe Ma EPA\n\n";
				...
				$sqltt = "UPDATE `session` SET `level`= 101 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` 
				FROM `epas` WHERE id = '4' LIMIT 7";	
				...
				$response = "CON Ma EPA a Ku Mzimba\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
														
				}
				$response .= "8. Kupitilira patsogolo\n";

			}elseif($userResponse=="5"){
				$sqltt = "UPDATE `session` SET `level`= 103 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '19'";	
				...
				$response = "CON Ma EPA a Ku NkhataBay\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
				...
				$sqltt = "UPDATE `session` SET `level`= 104  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '24'";	
				...
				$response .= "Mwasankha molakwika, Chonde Yeselaninso\n";
			}
			// Print the response onto the page so that our gateway can read it
			header('Content-type: text/plain');
			echo $response;			
			...
			if($userResponse=="1"){
				...
				$sql11e = "UPDATE `session` SET `level`=23 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqltt = "UPDATE `session` SET `level`= 71 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '4' AND ep_id BETWEEN 41 AND 46 LIMIT 7 ";	
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Mzenga', `farmer_district`='19' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
		...
		//CENTRAL REGION CHANGING DISTRICTS
		else if($level==74){
			if($userResponse=="1"){	
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 75 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '9' LIMIT 7";	
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 77  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	

				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '10' LIMIT 7";	
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 79  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 80  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 82 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 83  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				...
				$response .= "District: Ntcheu\n\n";
				$response .= "No EPAs For Ntcheu\n\n";
				...
				//query this on district level 
				$sql4="UPDATE `session` SET `level`= 84 where `session_id`='".$sessionId."'";
				$db->query($sql4);
				$response = "CON Select Your District\n";
				$response .= "Central Region Districts\n\n";
				$response .= "1. Ntchisi";
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqltt = "UPDATE `session` SET `level`= 76 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
			...
			if($userResponse=="1"){
				...
				WHERE id = '10' AND ep_id BETWEEN 88 AND 89 ";	
							
				//11e. Change level to 3
				$sql11e = "UPDATE `session` SET `level`= 78 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
			...
			if($userResponse=="1"){
				...
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` 
				WHERE id = '10' AND ep_id BETWEEN 20 AND 26";	
							
				//11e. Change level to 3
				$sql11e = "UPDATE `session` SET `level`= 81 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
			...
			if($userResponse=="1"){
				...
				$response = "END You Have Selected The Wrong Option.\nPlease Try Again\n";
			...
			if($userResponse=="1"){	
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 85 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '22' LIMIT 7";	
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
			...
			if($userResponse=="1"){
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Chipukwa', `farmer_district`='22' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Malomo', `farmer_district`='22' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Chikwatula', `farmer_district`='22' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Kalira'', `farmer_district`='22' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
		...
		//SOUTHERN REGION EPAS EMPLEMENTATION 
		else if($level==86){
			if($userResponse=="1"){
													
				$sqltt = "UPDATE `session` SET `level`= 87 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);		
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 88 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 89 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 90 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 91 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 92 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				$sqltt = "UPDATE `session` SET `level`= 93 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Mpilisi', `farmer_district`='5' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
			...
			if($userResponse=="1"){
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Msinkawanjala', `farmer_district`='17' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
		...
		//SOUTHERN REGION EPAS EMPLEMENTATION CONTINUATION 
		else if($level==94){
			if($userResponse=="1"){
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 95 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);		
				//query this on district level
				...
				$sqltt = "UPDATE `session` SET `level`= 96  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				$sqltt = "UPDATE `session` SET `level`= 97  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				...
				$response .= "District: Thyolo\n\n";
				$response .= "No EPAs For Thyolo\n\n";
				
				$response .= "1. Back\n";
				$response .= "2. Main Menu\n"; 

			}elseif($userResponse=="5"){
				$sqltt = "UPDATE `session` SET `level`= 98 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
			...
			if($userResponse=="1"){
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Makhanga', `farmer_district`='21' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Magoti', `farmer_district`='21' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Zunde', `farmer_district`='21' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
				...
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Nyachilenda', `farmer_district`='21' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
				$db->query($sqlb);
			...
			if($userResponse=="1"){
				...
				//11e. Change level to 3
				$sql11e = "UPDATE `session` SET `level`=61 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqltt = "UPDATE `session` SET `level`= 102 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '4' AND ep_id BETWEEN 41 AND 46 LIMIT 7 ";	
		...
		//CENTRAL REGION EPA EMPLEMATATION CHICHEWA
		else if($level==105){
			if($userResponse=="1"){	
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 106 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '9' LIMIT 7";	
				//for district level assignment
				...
				$response = "CON Ma EPA a Ku Dedza\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
														
				}
				$response .= "8. Ma EPA Ena A Ku Dedza\n";

			}elseif($userResponse=="2"){
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 108  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				...
				$response = "CON Ma EPA a Ku Dowa\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
													
				}
				$response .= "8. Ma EPA Ena A Ku Dowa\n";

			}elseif($userResponse=="3"){
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 110  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '12'";	
				...
				$response = "CON Ma EPA a Ku Kasungu\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 111 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '3' LIMIT 7";	
				...
				$response = "CON Ma EPA a Ku Lilongwe\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";
																
				}
				$response .= "8. Ma EPA Ena A Ku Lilongwe\n";							
				

			}elseif($userResponse=="5"){
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 112 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '16'";	
				...
				$response = "CON Ma EPA a Ku Mchinji\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
				...
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 113  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '20'";	
				...
				$response = "CON Ma EPA a Ku Nkhotakota\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
			...
			if($userResponse=="1"){
				...
				//11b. Update Name, and Request for District Name
				$sqltt = "UPDATE `session` SET `level`= 107 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);	
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '9' AND ep_id BETWEEN 76 AND 79 ";	
			...
			if($userResponse=="1"){
				...
				//11e. Change level to 3
				$sql11e = "UPDATE `session` SET `level`= 109 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
		...
		//START WITH KASUNGU ON LEVEL 79 GOING TO LEVEL 110
		else if($level==110){
			if($userResponse=="1"){
				//11b. Update Name, and Request for District Name
				$sqlb = "UPDATE farmers SET `farmer_epa`='Santhe', `farmer_district`='12' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
			...
			if($userResponse=="1"){
				...
				//11e. Change level to 3
				$sql11e = "UPDATE `session` SET `level`= 112 WHERE `session_id`='".$sessionId."'";
				$db->query($sql11e);
				//for district level assignment
				$farmers=$db->query($sql6);
				$farmerAvailable=$farmers->fetch_assoc();
				...
				$response = "END Mwasnakha Molakwika, Chonde Yeselaninso\n";
			...
			if($userResponse=="1"){	
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 115 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);							
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '22' LIMIT 7";	
				//for district level assignment
				...
				$response = "CON Ma EPA a Ku Ntchisi\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n";    
		...
		//SOURTHERN REGION DISTRICT CHANCE CHICHEWA
		else if($level==116){
			if($userResponse=="1"){
													
				$sqltt = "UPDATE `session` SET `level`= 117 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);		
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '5'";	
				...
				$response = "CON Ma EPA a Ku Balaka\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				...
				$sqltt = "UPDATE `session` SET `level`= 118 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '2'";	
				...
				$response = "CON Ma EPA a Ku Blantyre\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				...
				$sqltt = "UPDATE `session` SET `level`= 119 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '6'";	
				...
				$response = "CON Ma EPA a Ku Chikhwawa\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
				...
				$sqltt = "UPDATE `session` SET `level`= 120 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '7'";	
				...
				$response = "CON Ma EPA a Ku Chiradzulu\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
				...
				$sqltt = "UPDATE `session` SET `level`= 121 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '14'";	
				...
				$response = "CON Ma EPA a Ku Machinga\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
			}elseif($userResponse=="6"){
				$sqltt = "UPDATE `session` SET `level`= 122 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				$response = "CON Ma EPA a Ku Mulanje\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				...
				$sqltt = "UPDATE `session` SET `level`= 123 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '18'";	
				...
				$response = "CON Ma EPA a Ku Mwanza\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
				...
				$db->query($sql4);
				$response = "CON Sankhani Boma Lomwe Mukhala\n";
				$response .= "Chigawo Cha Ku Mwera\n\n";
				$response .= "1. Neno\n";
				$response .= "2. Nsanje\n";
				$response .= "3. Phalombe\n";
				$response .= "4. Thyolo\n";
		...
		//SOUTHERN REGION EPAS EMPLEMENTATION CONTINUATION 
			...
			if($userResponse=="1"){
				// Graduate user to level 2
				$sqltt = "UPDATE `session` SET `level`= 125 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);		
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '13'";	
				...
				$sqltt = "UPDATE `session` SET `level`= 126  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				...
				$response = "CON Ma EPA a Ku Nsanje\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
			}elseif($userResponse=="3"){
				$sqltt = "UPDATE `session` SET `level`= 127  WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '23'";	
				...
				$response = "CON Ma EPA a Ku Phalombe\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
				...
				$sqltt = "UPDATE `session` SET `level`= 128 WHERE `session_id`='".$sessionId."'";
				$db->query($sqltt);
				//query this on district level
				$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '1'";	
				...
				$response = "CON Ma EPA a Ku Zomba\n";
				$response .= "Sankhani Komwe Mukukhala\n\n";
				foreach($farmers as $index=>$farmers){
					$response.= ($index + 1) .". ".$farmers['epaname']."\n"; 
				}
				...
				switch ($level) {
					...
					case 8:// SOUTHERN REGION CONTINUATION			
						if($userResponse=="1"){
							...
							$sqltt = "UPDATE `session` SET `level`= 37 WHERE `session_id`='".$sessionId."'";
							$db->query($sqltt);
							//query this on district level
							$sql6 = "SELECT DISTINCT `epaname` FROM `epas` WHERE id = '1'";	
					...
					case 35:
						...
						if($userResponse=="1"){
							...
							//11b. Update Name, and Request for District Name
							$sqlb = "UPDATE farmers SET `farmer_epa`='Nyachilenda', `farmer_district`='23' WHERE `phonenumber` LIKE '%". $phoneNumber ."%'";
							$db->query($sqlb);
