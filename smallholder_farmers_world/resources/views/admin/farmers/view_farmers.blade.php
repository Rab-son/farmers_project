            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="text-align: center; text-transform: capitalize"> {{ $farmer->sex }}</td>
                  ...
                  <div id="myModal{{ $farmer->id }}" class="modal hide">
                    ...
                    <div class="modal-body">
                      ...
                      <p style="text-align: center; text-transform: capitalize">Phone Number : 0{{ $farmer->phonenumber }} </p>
                      <p style="text-align: center; text-transform: capitalize">Farm Activity: {{ $farmer->farm_activity }} </p>
                      <p style="text-align: center; text-transform: capitalize">Sex: {{ $farmer->sex }} </p>
