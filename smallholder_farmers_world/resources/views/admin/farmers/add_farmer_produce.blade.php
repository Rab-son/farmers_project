...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Dashboard" class="tip-bottom"><i class="icon-dashboard"></i>Dashboard</a><a href="{{ url('/admin/add-farmer-produce') }}" class="current">Add Farmer Product</a> <a href="{{ url('/admin/view-products') }}">View Farmer Produce</a>  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-envelope"></i> </span>
            <h5>Add Farmer Produce</h5>
          </div>
          <div class="widget-content nopadding">
              <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-yield') }}" name="add_product" id="add_product" novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="produce_name" id="produce_name" style="width: 578px;">
                </div>
              </div>
              <div class="control-group">
